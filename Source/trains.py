# I decided to quickly write the code for this program to see where I am going with it. It is not
# intended to run or even be correct but rather just to be something that I could work with to practice
# unit testing. I included limited comments and sloppy code because coding it was not the point.
# I will speak with you tomorrow morning and we can see what kinds of things I could have
# improved on and speak about other ways of testing. I learned alot of this today so please feel free to
# criticize my work - it's the only way I will get better.
